...
export function TeacherUpdateModalTable({
  ...
  return (
    <table>
      <tbody>
        <tr>
          <td className="text-base bg-text border border-text p-2 border-b-base">名前</td>
        ...
        <tr>
          <td className="text-base bg-text border border-text p-2 border-b-base">メールアドレス</td>
          <td className="border border-text p-2">
            <input
              type="email"
        ...
        <tr>
            <td className="text-base bg-text border border-text p-2">科目</td>
            <td className="border border-text p-2">
                <Select
                    multi={true}
                    options={subjects}
                    value={subjects.filter(
                        (subject) => updateTeacher.subjectIds?.includes(subject.value),
                    )}
